...
#Halaman Hitung Molaritas
        with tabs[3] :  
            ...
            st.latex(r''' \text{Molaritas} = \frac{\text{massa(g)}}{\text{Berat Molekul(g/mol)} \times \text{Volume(mL)}} ''')
 ...
 #Halaman Hitung Normalitas
        with tabs[4] :
            ...
            st.latex(r''' \text{Normalitas} = \frac{\text{massa(g)}}{\text{Berat Ekuivalen(g/grek)} \times \text{Volume(mL)}} ''')
